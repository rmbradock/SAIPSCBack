...
public class ListParticipacao extends javax.swing.JFrame {
    ...
    public void listarPorId(int pId){
        try{
            ...
            ResultSet resultSet = daoParticipacao.listarPorId(pId);
    ...
    public void listarPorNome(String pNome){
        try{
            ...
            ResultSet resultSet = daoParticipacao.listarPorNome(pNome);
    ...
    public void listarPorCompeticao(String pCompeticao){
        try{
            DefaultTableModel defaultTableModel = (DefaultTableModel) tableParticipacao.getModel();
            ...
            ResultSet resultSet = daoParticipacao.listarPorCompeticao(pCompeticao);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        switch (jcbTipoFiltro.getSelectedIndex()){
            ...
            break;
            case 3:
            listarPorCompeticao(tfFiltro.getText());
            break;
        }
